...
public final class VaporeonEntities {
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES =
            DeferredRegister.create(Registries.ENTITY_TYPE, ProductiveFoxes.MODID);

    public static final DeferredHolder<EntityType<?>, EntityType<VaporeonEntity>> VAPOREON =
            ENTITY_TYPES.register("vaporeon", () -> EntityType.Builder
                    .of(VaporeonEntity::new, MobCategory.CREATURE)
                    .sized(0.72F, 0.92F)
                    .clientTrackingRange(10)
                    .build(ProductiveFoxes.MODID + ":vaporeon"));

    private VaporeonEntities() {
    }
}
